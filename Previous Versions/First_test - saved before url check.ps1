...
$htmlbody = "$PageBoxOpener $ReportVmHost $BoxContentOpener $VmHost $PageBoxCloser "
$htmlbody = $htmlbody + "$br $ReportGetCluster $BoxContentOpener $GetCluster $PageBoxCloser "
...
$htmlbody = $htmlbody + "$br $ReportGetVmCluster $BoxContentOpener $GetVmCluster $PageBoxCloser "
