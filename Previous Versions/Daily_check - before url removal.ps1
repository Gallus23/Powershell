...
$gettemp=get-vm -name temp* | select name, vmhost, MemoryGB, powerstate | sort-object name | ConvertTo-HTML -Fragment
#--------------------------------------------------------------------------------------------------------------------------------------
# Check Sites URL VCD
write-host "Cehcking VCD URL......."
...
$ReportVmHost="<div id='boxheader'>Host Information $Location Stats for the last 24hrs </div> <div id='subtitle'> <p>Warning set at level $High_cpu_warn% and Alert level set at $High_cpu_alert% </p> </div>"
